const CACHE='luna-suite-v2';
const APPS=['./v075c.html','./notes-v013.html','./finance-v0298.html'];
const CORE=['./index.html',...APPS,'./manifest.webmanifest','./notes-v01.webmanifest','./finance-v01.webmanifest','./icon.svg','./notes-icon.svg'];
